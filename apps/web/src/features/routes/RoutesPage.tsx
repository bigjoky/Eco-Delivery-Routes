    ...
    <section className="page-grid">
      <Card>
        ...
        <CardContent>
          ...
          {createPreviewConflicts.length > 0 ? <div className="helper error">{createPreviewConflicts.join(' ')}</div> : null}
          {createRecommendedSubcontractorId && !createSubcontractorId ? (
            <div className="helper">Sugerencia: subcontrata recomendada {createRecommendedSubcontractorId}</div>
          ) : null}
