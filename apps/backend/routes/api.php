...
use App\Http\Controllers\Api\V1\Ops\VehicleControlController;
...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::patch('workforce/{id}', [WorkforceController::class, 'update']);
        ...
        Route::patch('compliance-documents/{id}', [ComplianceDocumentController::class, 'update']);
        Route::delete('compliance-documents/{id}', [ComplianceDocumentController::class, 'destroy']);
        Route::get('vehicle-controls', [VehicleControlController::class, 'index']);
        Route::post('vehicle-controls', [VehicleControlController::class, 'store']);
        Route::patch('vehicle-controls/{id}', [VehicleControlController::class, 'update']);
        Route::delete('vehicle-controls/{id}', [VehicleControlController::class, 'destroy']);
