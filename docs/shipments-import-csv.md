...
2. `external_reference` (opcional, referencia del cliente)
...
- `external_reference` se usa para la referencia del cliente. La referencia interna se genera automaticamente.
- `service_type` permitido: `express_1030`, `express_1400`, `express_1900`, `economy_parcel`, `business_parcel`, `thermo_parcel`.
